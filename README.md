...
<div align="center">
  ...
  <h3 align="center">Food Recipe API : Backend Food Recipe</h3>
  ...
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://share-recipe-food-api.herokuapp.com/">View Web Service</a>
  </p>
</div>
...
- Clone the Repo
```
git clone https://github.com/rifanhidayatulloh/Food-recipe-api.git
```
- Go To Folder Repo
```
cd food-recipe
...
npm install
```
- Make a new database and import [food-recipe.sql](./roast.sql)
...
Project Link: [https://github.com/rifanhidayatulloh/Food-recipe-api](https://github.com/rifanhidayatulloh/Food-recipe-api)
